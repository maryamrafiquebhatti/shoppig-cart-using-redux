...
const Detail = () => {
  ...
  return (
    <div>
        <h2 className='text-2xl text-center'>PRODUCT DETAIL</h2>
        <div className='grid grid-cols-2 gap-5 mt-5'>
            <div>
                <img src={detail.image} alt="" className='w-full'/>
            </div>
            <div className='flex flex-col gap-5'>
                <h1 className='text-2xl uppercase font-bold'>{detail.name}</h1>
                ...
                <div className='flex gap-5'>
                    ...
                    <button className='bg-slate-900 text-white px-3 py-3 rounded-xl shadow-2xl' onClick={handleAddToCart}>
                        Add To Cart
                    </button>
                </div>
                <p>
